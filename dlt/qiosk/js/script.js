                    ...
                    clientDiv.innerHTML = `
                        <div class="details pending">
                            ...
                            <div class="item details">
                                ...
                                <p class="info" id="time_difference"><i class="fa-regular fa-clock"></i> ${client.time_difference} waiting</p>
                            </div>
                        </div>
                    `;
            ...
            var adminDetails = `
                <div class="admin-item">
                    <div class="modal-header">
                        ...
                        <button class="forward-button" data-admin='${JSON.stringify(admin)}'><i class="fa-solid fa-paper-plane"></i> Send</button>
                    </div>
                </div>
            `;
