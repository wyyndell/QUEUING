...
if (isset($_POST['disable'])) {
    ...
    try {
        ...
        echo '<script>alert("Office and corresponding services updated successfully."); window.location = "operation.php";</script>';
    } catch (PDOException $e) {
        // Rollback the transaction if an error occurred
        $db->rollBack();

        // Error occurred while updating
        echo '<script>alert("Error: Unable to update office and corresponding services."); window.location = "operation.php";</script>';
    }
}
?>
