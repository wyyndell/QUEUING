...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        echo '<script>alert("Office and corresponding services deleted successfully."); window.location = "administration_management.php";</script>';
    } catch (PDOException $e) {
        // Rollback the transaction if an error occurred
        $db->rollBack();

        // Error occurred while deleting
        echo '<script>alert("Error: Unable to delete office and corresponding services."); window.location = "administration_management.php";</script>';
    }
}
?>
